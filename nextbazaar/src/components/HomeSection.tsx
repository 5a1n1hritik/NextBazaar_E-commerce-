        ...
        {/* <section className="container px-4 md:px-6">
          <div className="grid gap-6 md:grid-cols-2">
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="absolute inset-0 -z-10 bg-gradient-to-r from-background/100 to-background/0" />
              <Image
                src= {assets.images.Fashion_Sale_Banner}
                alt="New arrivals"
                fill
            ...
            <div className="relative overflow-hidden rounded-lg">
              ...
              <Image
                src="https://m.media-amazon.com/images/G/01/DiscoTec/2025/Deals/BigSpringSale/LandingPage/Wave_3_Headers/EN/BSS25-2587-LP-Header-LU-TDP-Page-DSK-1500x175.jpg"
                alt="Special offers"
                fill
                className="object-cover -z-20"
                sizes="(max-width: 768px) 100vw, 50vw"
