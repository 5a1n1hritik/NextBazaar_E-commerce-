...
export default function InventoryPage() {
  return (
    <div className="flex container flex-col items-center justify-center bg-background p-4 text-center">
      <div className="max-w-md space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            We're working hard to bring you something amazing. Our website is under development and will be ready soon.
          </p>
        </div>
        ...
        <div className="text-sm text-muted-foreground">
          © {new Date().getFullYear()} NextBazaar. All rights reserved.
        </div>
      </div>
    </div>
  );
